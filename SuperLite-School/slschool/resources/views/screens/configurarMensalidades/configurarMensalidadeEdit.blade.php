@extends('layout.main')
@section('title', 'Sl School - Atualizar informações sobre a configuração')
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Atualizar conf. Menaslidades</li>
                        </ol>
                    </div>

                    <h4 class="page-title">Atualizar informações sobre a configuração</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card border p-2">
                            <form action="{{ route('configurar_mensalidade.update', $configurar->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="number" class="form-control" step="0.01" min="0.01"
                                            name="juros" id="juros" required value="{{ $configurar->juros }}">
                                    </div>

                                    <div class="col-md-6 mb-4">
                                        <label for="multa" class="form-label">Multa</label>
                                        <input type="number" class="form-control" step="0.01" min="0.01"
                                            name="multa" id="multa" required value="{{ $configurar->multa }}">
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label for="mensagem" class="form-label">Mensagem do carnê</label>
                                    <textarea class="form-control text-start" name="mensagem" id="mensagem" cols="30" rows="2" maxlength="50">
                                    {{ $configurar->mensagem }}
                                    </textarea>
                                </div>
