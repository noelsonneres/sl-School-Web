                                    ...
                                    <td>
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <a href="{{ route('professores.edit', $disciplina->id) }}"
                                                ...
                                                <div class="col-2">
                                                    <a href="{{ route('professor_disciplinas.show', $disciplina->id) }}"
                                                        class="btn btn-info btn-sm" title="Disciplinas do professor">
                                                        <i class="uil-books"></i>
                                                    </a>
                                                </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" enctype="multipart/form-data"
                                                                        action="{{ route('professores.destroy', $disciplina->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
