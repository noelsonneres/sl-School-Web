                            ...
                            <form action="{{ route('salasAulas.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-9 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="sala" id="sala" maxlength="50" required>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="descricao" id="descricao" required maxlength="255">
                                </div>
