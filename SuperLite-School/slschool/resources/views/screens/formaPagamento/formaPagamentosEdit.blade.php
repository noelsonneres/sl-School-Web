@extends('layout.main')
@section('title', 'Sl School - Atualizar informações da forma de pagamento') 
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Atualizar Forma de Pagamento</li>
                        </ol>
                    </div>
                    
                    <h4 class="page-title">Visualizar ou atualizar Forma de Pagamento</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card border p-2">
                            <form action="{{ route('formas_pagamentos.update', $forma->id) }}" method="POST" enctype="multipart/form-data">

                                @csrf
                                @method('PUT')

                                <div class="mb-4">
                                    <label for="forma" class="form-label">Forma de pagamento <span class="text-danger">*</span> </label>
                                    <input type="text" class="form-control" name="forma" id="forma"
                                         required maxlength="50" autofocus value="{{$forma->formas}}">
                                </div>
