@extends('layout.main')
@section('title', 'Sl School - Nova forma de pagamento') 
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Cadastrar Forma de Pagamento</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card border p-2">
                            <form action="{{ route('formas_pagamentos.store') }}" method="POST" enctype="multipart/form-data">
