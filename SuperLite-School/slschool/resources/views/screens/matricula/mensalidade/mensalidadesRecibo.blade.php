    ...
    <div class="container pt-5">
        ...
        <div class="card ps-2 pe-2" id="print">
            ...
            <div class="pb-3">
                ...
                <p class="border p-1 m-0" style="font-size: 12px">Aluno(a): {{ $mensalidade->alunos->nome }}</p>
                <p class="border p-1 m-0" style="font-size: 12px">Código: {{ $mensalidade->alunos_id }} | Matrícula:
                ...
                <p class="border p-1 m-0" style="font-size: 12px"><span style="font-weight: 600">Data de pagamento:
                    ...
                    Forma de pagamento: {{ $mensalidade->formasPagamentos->formas }}
                </p>
                <p class="border p-1 m-0" style="font-size: 12px">
                    Responsável pelo pagamento: {{ $mensalidade->responsavel_pagamento }}
                </p>
                <p class="border p-1 m-0" style="font-size: 12px">
            ...
            <div class="pb-3">
                ...
                <p class="border p-1 m-0" style="font-size: 12px"><span style="font-weight: 600">Data de pagamento:
                        {{ date('d/m/Y', strtotime($mensalidade->data_pagamento)) }}</span> |
                    <span style="font-weight: 800">Pago: {{ $mensalidade->pago }}</span> | Forma de pagamento:
                    {{ $mensalidade->formasPagamentos->formas }}
                </p>
                <p class="border p-1 m-0" style="font-size: 12px">
                    Responsável pelo pagamento: {{ $mensalidade->responsavel_pagamento }}
                </p>
