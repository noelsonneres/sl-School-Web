                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card border p-2">
                            <form action="{{('/matricula_materiais_ad_parcela')}}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-4">
                                            ...
                                            <input type="text" class="form-control" id="codAluno"
                                                value="{{ $material->alunos_id }}" readonly>
                                        </div>

                                        <div class="col-md-2 mb-4">
                                            <label for="matricula" class="form-label">Matrícula</label>
                                            <input type="text" class="form-control" id="matricula"
                                                value="{{ $material->matriculas_id }}" readonly>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="number" step="0.01" min="0.01" class="form-control"
                                            name="valor" id="valor" value="{{ $material->valor_total }}" required
