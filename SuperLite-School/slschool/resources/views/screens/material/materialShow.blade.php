@extends('layout.main')
@section('title', 'Sl-School - Materiais escolares')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Materiais escolares</h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="pt-3 ps-4">
                                <a href="{{ route('material.create') }}" class="btn btn-primary">Novo</a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        ...
                                                        data-bs-target="#myModal{{ $material->id }}">
                                                        <i class="uil-trash-alt"></i>
                                                    </button>

                                                    {{-- Modal --}}
                                                    <div class="modal fade" id="myModal{{ $material->id }}"
                                                        tabindex="-1" aria-labelledby="myModalLabel{{ $material->id }}"
                                                        aria-hidden="true">
