@extends('layout.main')
@section('title', 'Sl School - Atualizar informações do consultor')
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Informações do consultor</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Visualizar ou atualizar informações do consultor</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="nome" id="nome" required
                                            maxlength="100" value="{{$consultor->nome}}">
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="cpf" id="cpf"
                                            onchange="formatarCPF(this)" value="{{$consultor->cpf}}">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            ...
                                            <input type="date" class="form-control" name="dataNascimento"
                                                id="dataNascimento" value="{{$consultor->data_nascimento}}">
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="dataCadastro" class="form-label">Data de cadastro</label>
                                            <input type="date" class="form-control" name="dataCadastro"
                                                id="dataCadastro" value="{{$consultor->data_cadastro}}">
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="telefone" class="form-label">Telefone</label>
                                            <input type="text" class="form-control" name="telefone" id="telefone"
                                                oninput="formatarTelefone(this)" value="{{$consultor->telefone}}">
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="celular" class="form-label">Celular</label>
                                            <input type="text" class="form-control" name="celular" id="celular"
                                                oninput="formatarCelular(this)" value="{{$consultor->celular}}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            ...
                                            <input type="text" class="form-control" name="cep" id="cep"
                                                oninput="formatarCEP(this)" value="{{$consultor->cep}}">
                                        </div>

                                        <div class="col-md-9 mb-4">
                                            <label for="endereco" class="form-label">Endereço</label>
                                            <input type="text" class="form-control" name="endereco" id="endereco"
                                                maxlength="100" value="{{$consultor->endereco}}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input type="text" class="form-control" name="bairro" id="bairro"
                                                maxlength="100" value="{{$consultor->bairro}}">
                                        </div>

                                        <div class="col-md-2 mb-4">
                                            <label for="numero" class="form-label">Número</label>
                                            <input type="text" class="form-control" name="numero" id="numero"
                                                maxlength="10" value="{{$consultor->numero}}">
                                        </div>

                                        <div class="col-md-4 mb-4">
                                            <label for="complemento" class="form-label">Complemento</label>
                                            <input type="text" class="form-control" name="complemento"
                                                maxlength="50" value="{{$consultor->complemento}}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mb-4">
                                            ...
                                            <input type="text" class="form-control" name="cidade" id="cidade"
                                                maxlength="50" value="{{$consultor->cidade}}">
                                        </div>

                                        <div class="col-md-3 mb-4">
                                            <label for="estado" class="form-label">Estado</label>
                                            <select class="form-control" name="estado" id="estado">
                                                <option value="{{$consultor->estado}}">{{$consultor->estado}}</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="obs" id="obs"
                                            maxlength="255" value="{{$consultor->obs}}">
                                    </div>
