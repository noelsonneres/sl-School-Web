  ...
  <div class="capa">
    <div class="grid">
      <div class="col4" style="padding-top: 70px">
        <img src="/img/logo/{{$empresa->foto}}" style="height: 100px">
      </div>
      <div class="col8" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0">
        <h2>Carnê de Pagamento</h2>
        <h3>{{$empresa->nome}}</h3>
        <p>{{$empresa->endereco}}, {{$empresa->bairro}}, {{$empresa->numero}}, 
            {{$empresa->cep}}, {{$empresa->cidade}} - {{$empresa->estado}}</p>
        <p>Telefone: {{$empresa->telefone}} Celular: {{$empresa->celular}}</p>    
