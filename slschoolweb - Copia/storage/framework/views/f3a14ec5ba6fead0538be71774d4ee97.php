<?php $__env->startSection('title', 'Novo responsavel'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <hr>
            <h4 class="ps-3">Aluno(a): <?php echo e($nomeAluno); ?></h4>
        <hr>
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('responsavel.store')); ?>" method="post" enctype="multipart/form-data">

                <?php echo csrf_field(); ?>

                    <input type="hidden" name="idAluno" name="idAluno" value="<?php echo e($idAluno); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" class="cep" name="cep" id="cep">
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/responsavel/responsavelCreate.blade.php ENDPATH**/ ?>