    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="<?php echo e(('/matricula_disciplina_adicionar/'.$matricula->id)); ?>" class="btn btn-primary">
            ...
            <table class="table p-1">
                ...
                <?php $__currentLoopData = $disciplinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disciplina): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><?php if($disciplina->inicio): ?>
                                <?php echo e(date('d/m/Y', strtotime($disciplina->inicio))); ?> </td>
                        <?php endif; ?>

                        <td><?php if($disciplina->termino): ?>
                                <?php echo e(date('d/m/Y', strtotime($disciplina->termino))); ?> </td>
                        <?php endif; ?>
