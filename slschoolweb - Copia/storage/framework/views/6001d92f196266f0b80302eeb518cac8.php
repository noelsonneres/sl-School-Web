<?php $__env->startSection('title', 'Visualizar ou atualizar informações do responsável'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <form method="POST" class="delete-form" action="<?php echo e(route('responsavel.destroy', $responsavel->id)); ?>">
                            <?php echo csrf_field(); ?>
        ...
        <hr>
            <h4 class="ps-3">Aluno(a): <?php echo e($aluno->nome); ?></h4>
        <hr>
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('responsavel.update', $responsavel->id)); ?>" method="post" enctype="multipart/form-data">

                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                    <input type="hidden" name="idAluno" name="idAluno" value="<?php echo e($aluno->id); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" name="nome" id="nome"
                                placeholder="Digite o nome do responsável" autofocus required 
                                    maxlength="100" value="<?php echo e($responsavel->nome); ?>">
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="apelido" id="apelido"
                                maxlength="50" value="<?php echo e($responsavel->apelido); ?>">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control" name="dataNascimento" id="dataNascimento"
                                value="<?php echo e($responsavel->data_nascimento); ?>">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" class="cep" name="cep"
                                 id="cep" value="<?php echo e($responsavel->cep); ?>">
                        </div>

                        <div class="col-md-9 mb-3">
                            <label for="endereco" class="form-label lblCaption">Endereço</label>
                            <input type="text" class="form-control" name="endereco" id="endereco"
                                maxlength="100" value="<?php echo e($responsavel->endereco); ?>">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 mb-3">
                            ...
                            <input type="text" class="form-control" name="cidade" id="cidade" 
                                maxlength="50" value="<?php echo e($responsavel->cidade); ?>">
                        </div>

                        <div class="col-md-3 mb-3">
                            <label for="estado" class="form-label lblCaption">Estado</label>
                            <input type="text" class="form-control" name="estado" id="estado" 
                                maxlength="2" value="<?php echo e($responsavel->estado); ?>">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="estadoCivil" id="estadoCivil"
                                maxlength="20" value="<?php echo e($responsavel->estado_civil); ?>">                             
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="profissao" id="profissao" 
                                value="<?php echo e($responsavel->profissao); ?>">                                
                        </div>                        
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="obs" id="obs"
                            value="<?php echo e($responsavel->observacao); ?>">    
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img id="imagemSelecionada" class="img-thumbnail" alt="" width="250px"
                            src="/img/responsavel/<?php echo e($responsavel->foto); ?>">
                    </div>                    
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/responsavel/responsavelEdit.blade.php ENDPATH**/ ?>