    ...
    <div class="card-body">
      <div class="row">
            ...
            <div id="test" class="qr">
                ...
                <script>
                    ...
                    var info = 'Nome: '+'<?php echo e($carteiras->alunos->nome); ?>\n' +
                                ...
                                'Curso: '+'<?php echo e($carteiras->matriculas->cursos->curso); ?>\n'+
                                'Escola: '+'<?php echo e($empresa->nome); ?>  - <?php echo e($empresa->cnpj); ?>\n'+
        ...
        <div class="col-md-9">
          ...
          <h5><?php echo e($carteiras->alunos->nome); ?></h5>
          <p class="texto">Matrícula: <?php echo e($carteiras->matriculas_id); ?></p>
          <p style="font-size: 14px; margin-bottom: 2px">Curso: <?php echo e($carteiras->matriculas->cursos->curso); ?></p>
