        ...
        <form action="{{route('matricula.update', $matricula->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4">
                    ...
                    <input type="number" onchange="calcular()" class="form-control" 
                        name="qtdeParcelas" id="qtdeParcelas" value="{{$matricula->qtde_parcela}}">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" class="form-control" step="0.01" min="0.01" 
                        name="valorAVista" id="valorAVista" value="{{$matricula->valor_a_vista}}">
                </div>

                <div class="col-md-3 mb-3">
                    <label for="valorComDesconto" class="form-label lblCaption">Valor com desconto</label>
                    <input type="number" class="form-control" step="0.01" min="0.01" 
                        name="valorComDesconto" id="valorComDesconto" value="{{$matricula->valor_com_desconto}}">                    
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" class="form-control" step="0.01" min="0.01" 
                        name="valorPorParcela" id="valorPorParcela" oninput="calcular()" value="{{$matricula->valor_por_parcela}}">                      
                </div>                
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" class="form-control" name="vencimentoMatricula" 
                        id="vencimentoMatricula" value="{{$matricula->vencimento_matricula}}">
                </div>                
            ...
            <div class="mb-4">
                ...
                <input class="form-control" type="text" id="obs" name="obs"
                     maxlength="255" value="{{$matricula->obs}}">
            </div>
