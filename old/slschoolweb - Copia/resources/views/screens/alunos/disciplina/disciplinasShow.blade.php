    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="{{('/matricula_disciplina_adicionar/'.$matricula->id)}}" class="btn btn-primary">
            ...
            <table class="table p-1">
                ...
                @foreach ($disciplinas as $disciplina)
                    ...
                    <tr>
                        ...
                        <td>@if($disciplina->inicio)
                                {{date('d/m/Y', strtotime($disciplina->inicio))}} </td>
                        @endif

                        <td>@if($disciplina->termino)
                                {{date('d/m/Y', strtotime($disciplina->termino))}} </td>
                        @endif
