...
<head>
    ...
    <title>Informações Saída de Valores</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <header class="mb-4">
            <h1>Informações Saída de Valores</h1>
        </header>
        ...
        <table class="table table-bordered table-responsive">
            ...
            <tr>
                <td>Código: {{$saida->id}}</td>
                <td colspan="2">Motivo: {{$saida->motivo}}</td>
            </tr>

            <tr>
                <td>Data: {{date('d/m/Y', strtotime($saida->data))}}</td>
                <td>Hora: {{$saida->hora}}</td>
                <td>Valor: R$ {{number_format( $saida->valor, 2, ',', '.') }}</td>
            </tr>

            <tr>
                <td colspan="3">Observação: {{$saida->observacao}}</td>
            </tr>
