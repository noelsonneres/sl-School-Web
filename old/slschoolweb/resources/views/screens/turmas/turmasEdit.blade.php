            ...
            <form action="{{ route('turma.update', $turmas->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="turma" id="turma" maxlength="100" autofocus
                        required autocomplete="off" value="{{ $turmas->turma }}">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control" name="horarios" id="horarios">
                            ...
                            <option value="{{ $turmas->cadastroHorarios->id }}">{{ $turmas->cadastroHorarios->entrada }}
                                às
                                {{ $turmas->cadastroHorarios->saida }}</option>

                            @foreach ($horarios as $horario)
                                <option value="{{ $horario->id }}">{{ $horario->entrada }} às {{ $horario->saida }}
                                </option>
                            @endforeach
