...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <a href="{{route('consultores.create')}}" class="btn btn-primary">
                    ...
                    <td>
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <a href="{{ route('consultores.edit', $consultor->id) }}" class="btn btn-success btn-sm">
                                ...
                                <div class="col-2">
                                    ...
                                    <form method="POST" class="delete-form" action="{{ route('consultores.destroy', $consultor->id) }}">
                                        @csrf
