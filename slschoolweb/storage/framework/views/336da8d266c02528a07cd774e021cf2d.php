<?php $__env->startSection('title', 'Editar informações da empresa'); ?>
...
<div class="container">
    ...
    <div class="card p-5">
        ...
        <form action="<?php echo e(route('empresa.update', $empresa->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="razao_social" id="razao_social" 
                    placeholder="Digite a razão social" maxlength="50" value="<?php echo e($empresa->razao_social); ?>">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    value="<?php echo e($empresa->data_aberturra); ?>">
                </div>

                <div class="col-md-3 mb-3">
                    <label for="cnpj" class="form-label lblCaption">CNPJ</label>
                    <input type="text" class="form-control" name="cnpj" id="cnpj"
                    value="<?php echo e($empresa->cnpj); ?>">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 mb-3">
                    ...
                    <input type="text" class="form-control" name="cidade" id="cidade" maxlength="50"
                        value="<?php echo e($empresa->cidade); ?>">
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="obs" id="obs" value="<?php echo e($empresa->obs); ?>">
            </div>
            ...
            <div class="mb-4">
                ...
                <img id="imagemSelecionada" class="img-thumbnail" alt="" width="250px" src="/img/logo/<?php echo e($empresa->foto); ?>">
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/empresa/empresaEdit.blade.php ENDPATH**/ ?>