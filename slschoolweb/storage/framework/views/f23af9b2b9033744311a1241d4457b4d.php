...
<?php $__env->startSection('title', 'Lista de alunos bloqueados'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-5 border p-2 me-3">
                    <form action="/bloqueados_loc_datas" method="get">
                        <?php echo csrf_field(); ?>
                ...
                <div class="col border p-2">
                    <form action="/bloqueados_localizar" method="get">
                        <?php echo csrf_field(); ?>
        ...
        <div class="card pt-2 mt-4">
            ...
            <table class="table p-1">
                ...
                <tbody>
                    <?php $__currentLoopData = $bloqueados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bloqueado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($bloqueado->id); ?> </td>
                            <td><?php echo e($bloqueado->alunos_id); ?> </td>
                            <td><?php echo e($bloqueado->alunos->nome); ?> </td>
                            <td><?php echo e(date('d/m/Y', strtotime( $bloqueado->data ))); ?> </td>
                            <td><?php echo e($bloqueado->status); ?> </td>
                            ...
                            <td>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <a href="<?php echo e(('/bloqueados_visualizar/'.$bloqueado->id)); ?>" 
            ...
            <?php echo e($bloqueados->links('pagination::pagination')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/bloqueados/alunosBloqueadosShow.blade.php ENDPATH**/ ?>