<?php $__env->startSection('title', 'Finalizar matricula - Localizar matrícula'); ?>
                        ...
                        <td>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="<?php echo e(route('matricula_finalizar.show', $matricula->id)); ?>" class="btn btn-success btn-sm"
                                           title="
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/finalizar/localizarMatricula.blade.php ENDPATH**/ ?>