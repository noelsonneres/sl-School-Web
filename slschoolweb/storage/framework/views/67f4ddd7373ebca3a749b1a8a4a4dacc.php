<?php $__env->startSection('title', 'Reposição - Localizar matrícula'); ?>
<?php $__env->startSection('content'); ?>

    <div class="container">

        <div style="background-color: #1976D2;">
            <h3 class="text-center text-white p-3">Lançamento de reposições - Localizar matrícula</h3>
        </div>
        ...
        <div class="row ps-5">
            ...
            <div class="col-8">
                ...
                <form action="/resposicao_localizar_matricula" method="get">
                    <?php echo csrf_field(); ?>
                        ...
                        <td>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="<?php echo e(route('reposicoes.show', $matricula->id)); ?>" class="btn btn-info btn-sm"
                                           title="Marcar reposição para o aluno" >
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/reposicao/localizarMatricula.blade.php ENDPATH**/ ?>