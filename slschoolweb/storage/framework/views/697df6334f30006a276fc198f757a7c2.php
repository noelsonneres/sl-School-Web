...
<?php $__env->startSection('title', 'Atualizar informações do usuário'); ?>
                ...
                <div class="card border p-3 mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="usuario" id="usuario" 
                                        required maxlength="20" value="<?php echo e($usuario->user_name); ?>" autocomplete="off">
                        </div>               
                    ...
                    <div class="md-4 mt-4">
                        ...
                        <input type="email" class="form-control" name="email" id="email" 
                            required maxlength="100" value="<?php echo e($usuario->email); ?>" autocomplete="off">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="cpf" id="cpf" 
                               value="<?php echo e($usuario->documento); ?>" autocomplete="off">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" name="admissao" id="admissao" 
                                value="<?php echo e($usuario->data_admissao); ?>">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" name="desligamento" id="desligamento" 
                                value="<?php echo e($usuario->data_desligamento); ?>">                         
                        </div>                        
                ...
                <div class="card border p-3 mb-4">
                    ...
                    <div class="row mb-4">
                       ...
                       <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="telefone" id="telefone"
                                 autocomplete="off" value="<?php echo e($usuario->telefone); ?>">
                        </div> 

                        <div class="col-md-6">
                            <label for="celular" class="form-label lblCaption">Celular</label>
                            <input type="text" class="form-control" name="celular" id="celular"
                                 autocomplete="off" value="<?php echo e($usuario->celular); ?>">
                        </div>                         
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="cep" id="cep"
                                 autocomplete="off" value="<?php echo e($usuario->cep); ?>">
                        </div>

                        <div class="col-md-9">
                            <label for="endereco" class="form-label lblCaption">Endereço</label>
                            <input type="text" class="form-control" name="endereco" id="endereco"
                               value="<?php echo e($usuario->endereco); ?>"  autocomplete="off">
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="bairro" id="bairro" 
                               value="<?php echo e($usuario->bairro); ?>" autocomplete="off">
                        </div>

                        <div class="col-md-4">
                            <label for="complemento" class="form-label lblCaption">Complemento</label>
                            <input type="text" class="form-control" name="complemento" id="complemento" 
                               value="<?php echo e($usuario->complemento); ?>" autocomplete="off">
                        </div>

                        <div class="col-md-2">
                            <label for="numero" class="form-label lblCaption">Número</label>
                            <input type="text" class="form-control" name="numero" id="numero" 
                               value="<?php echo e($usuario->numero); ?>" autocomplete="off">                            
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" class="form-control" name="cidade" id="cidade" maxlength="100"
                               value="<?php echo e($usuario->cidade); ?>"  autocomplete="off">
                        </div>

                        <div class="col-md-3">
                            <label for="estado" class="form-label lblCaption">Estado</label>
                            <input type="text" class="form-control" name="estado" id="estado"
                                value="<?php echo e($usuario->estado); ?>" autocomplete="off">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="obs" id="obs" maxlength="255" 
                           value="<?php echo e($usuario->observacao); ?>" autocomplete="off">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img id="imagemSelecionada" class="img-thumbnail" alt="" width="250px"
                            src="/img/user/<?php echo e($usuario->foto); ?>">
                    </div>                    
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/usuarios/usuarioEdit.blade.php ENDPATH**/ ?>