            ...
            <form action="#" method="post">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" name="motivo" id="motivo" required 
                            maxlength="50" value="<?php echo e($bloqueado->motivo); ?>">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="obs" id="obs"
                        value="<?php echo e($bloqueado->obs); ?>">
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/bloqueados/alunoBloqueadoInfo.blade.php ENDPATH**/ ?>