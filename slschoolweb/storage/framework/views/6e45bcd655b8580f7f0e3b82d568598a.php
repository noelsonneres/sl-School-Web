...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('config_mensalidades.update', $config->id)); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="mensagem" id="mensagem" cols="30" 
                            rows="5" maxlength="75"><?php echo e($config->mensagem); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/configMensalidades/configMensalidadesEdit.blade.php ENDPATH**/ ?>