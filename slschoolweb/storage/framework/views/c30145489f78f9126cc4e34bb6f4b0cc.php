...
<?php $__env->startSection('title', 'Histórico de Matrículas Reativadas'); ?>
    ...
    <div class="container">
        ...
        <div class="card pt-2 mt-4">
            ...
            <table class="table p-1 table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $reativadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reativada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>

                            <td><?php echo e($reativada->matriculas_id); ?> </td>
                            <td><?php echo e($reativada->alunos_id); ?> </td>
                            <td><?php echo e($reativada->alunos->nome); ?> </td>
                            <td><?php echo e(date('d/m/Y', strtotime($reativada->data))); ?> </td>
                            <td><?php echo e($reativada->matriculas->status); ?> </td>
                            ...
                            <td>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <a href="<?php echo e(('/rel_reativadas_impressao/'.$reativada->id)); ?>" class="btn btn-success btn-sm"
            ...
            <div class="container-fluid pl-5 d-flex justify-content-center">
                <?php echo e($reativadas->links('pagination::pagination')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/relatorios/reativada/relMatriculasReativadasShow.blade.php ENDPATH**/ ?>