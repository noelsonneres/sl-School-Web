    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <a href="<?php echo e('/matricula_materiais_adicionar/' . $matricula->id); ?>"class="btn btn-primary mb-2">
                    <i class="bi bi-plus-circle-fill"></i>
                    Incuir material </a>

                <a href="<?php echo e('/matricula_material_parcelas/' . $matricula->id); ?>"class="btn btn-success mb-2"
