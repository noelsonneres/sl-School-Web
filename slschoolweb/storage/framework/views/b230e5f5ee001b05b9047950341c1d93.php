...
<?php $__env->startSection('title', 'Matrículas Finalizadas'); ?>
    ...
    <div class="container">
        ...
        <div class="card pt-2 mt-4">
            ...
            <table class="table p-1 table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $finalizados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $finalizado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>

                            <td><?php echo e($finalizado->matriculas_id); ?> </td>
                            <td><?php echo e($finalizado->alunos_id); ?> </td>
                            <td><?php echo e($finalizado->alunos->nome); ?> </td>
                            <td><?php echo e(date('d/m/Y', strtotime($finalizado->data))); ?> </td>
                            <td><?php echo e($finalizado->matriculas->status); ?> </td>
                            ...
                            <td>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <a href="<?php echo e(('/rel_finalizados_impressao/'.$finalizado->id)); ?>" class="btn btn-success btn-sm"
            ...
            <div class="container-fluid pl-5 d-flex justify-content-center">
                <?php echo e($finalizados->links('pagination::pagination')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/relatorios/finalizado/relMatriculasFinalizadasShow.blade.php ENDPATH**/ ?>