<?php $__env->startSection('title', 'Editar ou visualizar as informações do professor'); ?>
...
<div class="container">
    ...
    <div class="card p-5">
        ...
        <form action="<?php echo e(route('professores.update', $professor->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nome" id="nome"
                     placeholder="Digite um nome para o professor" maxlength="100" autofocus required
                        value="<?php echo e($professor->nome); ?>">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="date" class="form-control" name="dataNascimento" id="dataNascimento"
                        value="<?php echo e($professor->data_nascimento); ?>">
                </div>

                <div class="col-md-3 mb-3">
                    <label for="cpf" class="form-label lblCaption">CPF</label>
                    <input type="text" class="form-control" name="cpf" id="cpf" value="<?php echo e($professor->cpf); ?>">
                </div>

                <div class="col-md-3 mb-3">
                    <label for="telefone" class="form-label lblCaption">Telefone</label>
                    <input type="text" class="form-control" name="telefone" id="telefone" value="<?php echo e($professor->telefone); ?>">
                </div>
                
                <div class="col-md-3 mb-3">
                    <label for="celular" class="form-label lblCaption">Celular</label>
                    <input type="text" class="form-control" name="celular" id="celular" value="<?php echo e($professor->celular); ?>">
                </div>                
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="email" id="email" value="<?php echo e($professor->email); ?>">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="cep" id="cep" value="<?php echo e($professor->cep); ?>">
                </div>

                <div class="col-md-9 mb-3">
                    <label for="endereco" class="form-label lblCaption">Endereço</label>
                    <input type="text" class="form-control" name="endereco" id="endereco"
                         maxlength="100" value="<?php echo e($professor->endereco); ?>">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 mb-3">
                    ...
                    <input type="text" class="form-control" name="cidade" id="cidade" 
                        maxlength="50" value="<?php echo e($professor->cidade); ?>">
                </div>

                <div class="col-md-3 mb-3">
                    <label for="estado" class="form-label lblCaption">Estado</label>
                    <input type="text" class="form-control" name="estado" id="estado" 
                        value="<?php echo e($professor->estado); ?>">
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="obs" id="obs" value="<?php echo e($professor->obs); ?>">
            </div>
            ...
            <div class="mb-4">
                ...
                <img id="imagemSelecionada" class="img-thumbnail" alt="" width="250px" 
                    src="/img/professor/<?php echo e($professor->foto); ?>">
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/professores/professoresEdit.blade.php ENDPATH**/ ?>