<?php $__env->startSection('title', 'Atualizar informações da visita ou interesado'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('visitas.update', $visitas->id)); ?>" method="post">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nome" id="nome"
                               required maxlength="100" value="<?php echo e($visitas->nome); ?>">
                    </div>

                    <div class="col-md-3">
                        <label for="telefone" class="form-label lblCaption">Telefone</label>
                        <input type="text" class="form-control" name="telefone" id="telefone" value="<?php echo e($visitas->telefone); ?>">
                    </div>

                    <div class="col-md-3">
                        <label for="celular" class="form-label lblCaption">Celular</label>
                        <input type="text" class="form-control" name="celular" id="celular"
                               required value="<?php echo e($visitas->celular); ?>">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" class="form-control" name="email" id="email" maxlength="100"
                        value="<?php echo e($visitas->email); ?>">
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="cep" id="cep" value="<?php echo e($visitas->cep); ?>">
                    </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" name="endereco" id="endereco" maxlength="100"
                            value="<?php echo e($visitas->endereco); ?>">
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="bairro" id="bairro" maxlength="50" value="<?php echo e($visitas->bairro); ?>">
                    </div>

                    <div class="col-md-2">
                        <label for="numero" class="form-label lblCaption">Número</label>
                        <input type="number" class="form-control" name="numero" id="numero" value="<?php echo e($visitas->numero); ?>">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="complemento" id="complemento" maxlength="50"
                               value="<?php echo e($visitas->complemento); ?>" >
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" name="cidade" id="cidade" maxlength="50"
                                value="<?php echo e($visitas->cidade); ?>">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="estado" id="estado" maxlength="2"
                            value="<?php echo e($visitas->estado); ?>">
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="retorno" id="retorno" maxlength="50"
                            value="<?php echo e($visitas->retorno); ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="situacao" id="situacao" maxlength="50"
                            value="<?php echo e($visitas->situacao); ?>">
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="grauInteresse" id="grauInteresse">
                            ...
                            <option value="<?php echo e($visitas->grau_interesse); ?>"><?php echo e($visitas->grau_interesse); ?></option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="curso" id="curso">
                            ...
                            <option value="<?php echo e($visitas->curso_de_interesse); ?>"><?php echo e($visitas->curso_de_interesse); ?></option>

                            <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($curso->curso); ?>"><?php echo e($curso->curso); ?></option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="turno" id="turno">
                            <option value="<?php echo e($visitas->turno); ?>"><?php echo e($visitas->turno); ?></option>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="dia" id="dia">
                            <option value="<?php echo e($visitas->dia); ?>"><?php echo e($visitas->dia); ?></option>
                            ...
                            <?php $__currentLoopData = $dias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dia->dia1); ?> - <?php echo e($dia->dia2); ?>"><?php echo e($dia->dia1); ?> - <?php echo e($dia->dia2); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="horarios" id="horarios">
                            <option value="<?php echo e($visitas->horario); ?>"><?php echo e($visitas->horario); ?></option>

                            <?php $__currentLoopData = $horarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $horario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($horario->entrada); ?> - <?php echo e($horario->saida); ?>"><?php echo e($horario->entrada); ?> - <?php echo e($horario->saida); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="obs" id="obs" maxlength="255"
                        value="<?php echo e($visitas->observacao); ?>">
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/visitas/visitasEdit.blade.php ENDPATH**/ ?>