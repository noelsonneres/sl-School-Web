<?php $__env->startSection('title', 'Reativar matricula - Localizar matrícula'); ?>
<?php $__env->startSection('content'); ?>

    <div class="container">

        <div style="background-color: #1976D2;">
            <h3 class="text-center text-white p-3">Reativar matrícula - Localizar matrícula</h3>
        </div>
        ...
        <div class="row ps-5">
            ...
            <div class="col-8">
                ...
                <form action="/matricula_reativar_localizar" method="get">
                    <?php echo csrf_field(); ?>
                        ...
                        <td>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="<?php echo e(route('matricula_reativar.show', $matricula->id)); ?>" class="btn btn-success btn-sm"
                                           title="
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/reativar/localizarMatricula.blade.php ENDPATH**/ ?>