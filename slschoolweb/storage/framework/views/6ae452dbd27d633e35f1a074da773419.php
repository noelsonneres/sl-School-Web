<?php $__env->startSection('title', 'Configurações da carteira'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('conf_carteira.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/confCarteira/configurarCarteiraCreate.blade.php ENDPATH**/ ?>