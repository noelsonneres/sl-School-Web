<?php $__env->startSection('title', 'Visualizar ou Editar Matrícula'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('matricula.update', $matricula->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        ...
                        <select class="form-control" name="curso" id="curso">
                            ...
                            <option value="<?php echo e($matricula->cursos->id); ?>"><?php echo e($matricula->cursos->curso); ?></option>

                            <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($curso->id); ?>" data-qtde-parcelas="<?php echo e($curso->qtde_parcelas); ?>"
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <input type="number" onchange="calcular()" class="form-control" name="qtdeParcelas"
                            id="qtdeParcelas" value="<?php echo e($matricula->qtde_parcela); ?>">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0.01" name="valorAVista"
                            id="valorAVista" value="<?php echo e($matricula->valor_a_vista); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0.01" name="valorComDesconto"
                            id="valorComDesconto" value="<?php echo e($matricula->valor_com_desconto); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0.01" onchange="calcular()"
                            name="valorParcelado" id="valorParcelado" value="<?php echo e($matricula->valor_parcelado); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0.01" name="valorPorParcela"
                            id="valorPorParcela" oninput="calcular()" value="<?php echo e($matricula->valor_por_parcela); ?>">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" name="vencimento" id="vencimento"
                            value="<?php echo e($matricula->vencimento); ?>">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" step="0.01" min="0.01" name="valorMatricula"
                            id="valorMatricula" value="<?php echo e($matricula->valor_matricula); ?>">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" name="vencimentoMatricula" id="vencimentoMatricula"
                            value="<?php echo e($matricula->vencimento_matricula); ?>">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="date" onchange="CalcularDatas()" class="form-control" name="dataInicio"
                            id="dataInicio" value="<?php echo e($matricula->data_inicio); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="date" class="form-control" name="dataTermino" id="dataTermino"
                            value="<?php echo e($matricula->data_termino); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="number" class="form-control" name="qtdeDias" id="qtdeDias"
                            value="<?php echo e($matricula->qtde_dias); ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="number" class="form-control" name="qtdeHoras" id="qtdeHoras"
                            value="<?php echo e($matricula->horas_semana); ?>">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        ...
                        <select name="consultor" class="form-control" id="consultor" name="consultor">
                            ...
                            <?php if(isset($cons)): ?>
                                <option value="<?php echo e($cons->id); ?>"><?php echo e($cons->nome); ?></option>
                            <?php endif; ?>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input style="color: #1976D2; font-weight: 800" type="text" class="form-control"
                            name="ativo" id="ativo" readonly value="<?php echo e($matricula->status); ?>">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="text" id="obs" name="obs" maxlength="255"
                        value="<?php echo e($matricula->obs); ?>">
                </div>
                ...
                <div>
                    ...
                    <a href="<?php echo e('/matricula_home/' . $aluno->id); ?>" class="btn btn-danger">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/matricula/matriculaEdit.blade.php ENDPATH**/ ?>