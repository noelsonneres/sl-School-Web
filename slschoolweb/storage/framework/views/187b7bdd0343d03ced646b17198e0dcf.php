<?php $__env->startSection('title', 'Trancar Matrícula'); ?>
<?php $__env->startSection('content'); ?>

    <div class="container">

        <div style="background-color: #1976D2;">
            <h3 class="text-center text-white p-3">Trancar Matrícula</h3>
        </div>
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('trancar_matricula.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/trancar/trancarMatricula.blade.php ENDPATH**/ ?>