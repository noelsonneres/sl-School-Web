<?php $__env->startSection('title', 'Cancelar matricula - Localizar matrícula'); ?>
<?php $__env->startSection('content'); ?>

    <div class="container">

        <div style="background-color: #1976D2;">
            <h3 class="text-center text-white p-3">Cancelar matrícula - Localizar matrícula</h3>
        </div>
                        ...
                        <td>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="<?php echo e(('/cancelar_matricula/'.$matricula->id)); ?>" class="btn btn-danger btn-sm"
                                           title="Cancelar matrícula selecionada" >
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/alunos/cancelar/localizarMatricula.blade.php ENDPATH**/ ?>