<?php $__env->startSection('title', 'Incluir motivo para o cancelamento'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="<?php echo e(route('motivos_cancelamento.update', $motivo->id)); ?>" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="motivo" id="motivo" maxlength="50" autofocus
                        required value="<?php echo e($motivo->motivo); ?>">
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/motivoCancelamento/motivoCancelamentoEdit.blade.php ENDPATH**/ ?>