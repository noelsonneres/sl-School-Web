...
<?php $__env->startSection('title', 'Matrículas canceladas'); ?>
    ...
    <div class="container">
        ...
        <div class="card pt-2 mt-4">
            ...
            <table class="table p-1 table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $cancelados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cancelado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>

                            <td><?php echo e($cancelado->matriculas_id); ?> </td>
                            <td><?php echo e($cancelado->alunos_id); ?> </td>
                            <td><?php echo e($cancelado->alunos->nome); ?> </td>
                            <td><?php echo e(date('d/m/Y', strtotime($cancelado->data))); ?> </td>
                            <td><?php echo e($cancelado->motivo); ?> </td>
                            <td><?php echo e($cancelado->matriculas->status); ?> </td>
                            ...
                            <td>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <a href="<?php echo e(('/rel_cancelados_impressao/'.$cancelado->id)); ?>" class="btn btn-success btn-sm"
            ...
            <div class="container-fluid pl-5 d-flex justify-content-center">
                <?php echo e($cancelados->links('pagination::pagination')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/relatorios/cancelado/relMatriculaCanceladaShow.blade.php ENDPATH**/ ?>