    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 ms-3">
                ...
                <?php elseif($matricula->status == 'bloqueado'): ?>
                    <h5 style="color: rgb(143, 7, 7); font-weight: 700">Situação: <?php echo e($matricula->status); ?></h5>
                <?php endif; ?>
            ...
            <div class="col-md-2 mb-2">
                <form method="POST" class="delete-form" action="<?php echo e(route('matricula.destroy', $matricula->id)); ?>">
                    <?php echo csrf_field(); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="<?php echo e('/listarModeloContratosImpressao/' . $matricula->id); ?>" class="link-card">
                        <div class="card" style="display: flex; justify-content: center; align-items: center;">
                            <div class="card-body text-center">
            ...
            <div class="row">
                ...
                <?php if(isset($matricula->responsavels_id)): ?>
                    <div class="col-sm-2">
            ...
            <div class="row">
                ...
                <?php if($matricula->alunos->ativo == 'sim'): ?>
                    <div class="col-sm-2">
                        <a href="<?php echo e(route('bloqueados.show', $matricula->id)); ?>" class="link-card">
                            <div class="card" style="display: flex; justify-content: center; align-items: center;">
                                <div class="card-body text-center">
                ...
                <?php elseif($matricula->alunos->ativo == 'bloqueado'): ?>
                    <div class="col-sm-2">
                        <a href="<?php echo e(('/desbloquear_alunos_lista/'.$matricula->alunos->id)); ?>" class="link-card">
                            <div class="card" style="display: flex; justify-content: center; align-items: center;">
                                <div class="card-body text-center">
