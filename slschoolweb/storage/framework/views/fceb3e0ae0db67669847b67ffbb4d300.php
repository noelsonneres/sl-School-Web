<?php $__env->startSection('title', 'Atualizar informações do material'); ?>
...
<div class="container">
    ...
    <div class="card p-5">
        ...
        <form action="<?php echo e(route('materiais.update', $materiais->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="material" id="material"
                     placeholder="Digite um curso para o professor" maxlength="100"
                      autofocus required value="<?php echo e($materiais->material); ?>">
            </div>

            <div class="mb-3">
                <label for="descricao" class="form-label lblCaption">Descrição</label>
                <input type="text" class="form-control" name="descricao" id="descricao"
                     maxlength="100" value="<?php echo e($materiais->descricao); ?>">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" min="0.01" class="form-control" 
                        name="valorUn" id="valorUn" value="<?php echo e($materiais->valor_un); ?>">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="quantidade" class="form-label lblCaption">Quantidade</label>
                    <input type="number" class="form-control" name="quantidade" id="quantidade"
                        value="<?php echo e($materiais->qtde); ?>">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="ativo" class="form-label lblCaption">Ativo</label>
                    <select class="form-control" name="ativo" id="ativo">
                        <option value="<?php echo e($materiais->ativo); ?>"><?php echo e($materiais->ativo); ?></option>
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" name="obs" id="obs" maxlength="255"
                    value="<?php echo e($materiais->obs); ?>">
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\noels\OneDrive\Documentos\GitHub\sl-School-Web\slschoolweb\resources\views/screens/materiasEscolares/materiasEscolaresEdit.blade.php ENDPATH**/ ?>