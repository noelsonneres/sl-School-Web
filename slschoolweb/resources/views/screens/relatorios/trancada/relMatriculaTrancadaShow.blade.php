...
@section('title', 'Matrículas trancadas')
@section('content')
    ...
    <div class="container">
        ...
        <div class="card pt-2 mt-4">
                ...
                <tbody>
                    @foreach ($trancados as $trancado)
                        <tr>
                            ...
                            <td>{{ $trancado->matriculas_id }} </td>
                            <td>{{ $trancado->alunos_id }} </td>
                            <td>{{ $trancado->alunos->nome }} </td>
                            <td>{{ date('d/m/Y', strtotime($trancado->data)) }} </td>
                            <td>{{ $trancado->motivo}} </td>
                            <td>{{ $trancado->matriculas->status }} </td>
            ...
            <div class="container-fluid pl-5 d-flex justify-content-center">
                {{ $trancados->links('pagination::pagination') }}
            </div>
