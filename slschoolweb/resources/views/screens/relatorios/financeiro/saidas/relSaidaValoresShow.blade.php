...
@section('content')
    ...
    <div class="container">
        ...
        <div class="container border">
            ...
            <form action="/rel_saidas_valores_loc_datas" method="get" id="searchForm">
        ...
        <div class="container mt-4 border mb-4">
                ...
                <form action="/rel_saidas_valores_localizar" method="get">
        ...
        <div class="card pt-2 mt-4">
                        ...
                        <td>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="{{('/rel_saidas_valores_impressao/'.$saida->id)}}"
            ...
            <div class="container-fluid pl-5 d-flex justify-content-center">
                {{$saidas->links('pagination::pagination')}}
            </div>
