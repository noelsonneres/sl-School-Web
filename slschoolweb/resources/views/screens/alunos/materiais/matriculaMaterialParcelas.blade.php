    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="{{ route('matricula.show', $dadosAluno['matriculaID']) }}"class="btn btn-info">
        ...
        <h4 class="m-2">Aluno(a): {{$dadosAluno['alunoNome']}}</h4>
        <h5 class="m-2">Matricula: {{$dadosAluno['matriculaID']}} </h5>
        ...
        <div class="card p-5">
            ...
            <form action="{{('/matricula_material_gerar_parcela') }}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="matricula" id="matricula" value="{{$dadosAluno['matriculaID']}}">
                <input type="hidden" name="aluno" id="aluno" value="{{$dadosAluno['alunoID']}}">
                <input type="hidden" name="responsavel" id="responsavel" value="{{$dadosAluno['responsavelID']}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" min="0.01"  class="form-control" 
                         name="valor" id="valor" required value="{{$totalMateriais}}" readonly>
                    </div>
