    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <a href="{{ '/matricula_materiais_adicionar/' . $matricula->id }}"class="btn btn-primary mb-2">
                    <i class="bi bi-plus-circle-fill"></i>
                    Incuir material </a>

                <a href="{{ '/matricula_material_parcelas/' . $matricula->id }}"class="btn btn-success mb-2"
