        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="{{ '/responsavel_adicionar/' . $alunos->id . '/' . $alunos->nome }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 mb-3">
                        ...
                        <input type="text" class="form-control" name="aluno" id="aluno"
                            ...
                            autocomplete="off" value="{{ $alunos->nome }}">
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="apelido" name="apelido" maxlength="20"
                            autocomplete="off" value="{{ $alunos->apelido }}">
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="fobias" id="fobias"
                                    maxlength="100" value="{{ $alunos->fobias }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="alergias" id="alergias"
                                    maxlength="100" value="{{ $alunos->alergias }}">
                            </div>
