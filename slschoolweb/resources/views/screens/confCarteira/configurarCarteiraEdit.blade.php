...
@section('title', 'Atualizar informações da carteira')
@section('content')
    ...
    <div class="container">
        ...
        <div class="card p-5">
            ...
            <form action="{{route('conf_carteira.update', $conf->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" name="mensagem" id="mensagem"
                           ...
                           autofocus required maxlength="255" value="{{$conf->mensagem}}">
                </div>
